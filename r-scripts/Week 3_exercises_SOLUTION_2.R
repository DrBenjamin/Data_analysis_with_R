...
with(prostate,ageadjust.direct(count = `PC94-96`,pop = `Pop94-96`,stdpop = `Pop85-87`))
...
with(icu,ageadjust.indirect(count = HospitalDeaths,pop = HospitalPopulation,stdcount = StandardDeaths,stdpop = StandardPopulation))
