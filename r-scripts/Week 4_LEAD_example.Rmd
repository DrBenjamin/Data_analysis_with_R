...
```{r preamble}
# Load the packages
pacman::p_load(tidyverse, finalfit)
...
Now we can look at the distribution of abscore separated by each of the categorical variables, using grapical and numerical methods.
